...
export const NAV_ITEMS = [
  ...
  { href: "/tools/image", label: { zh: "AI 绘画", en: "Image" } },
  { href: "/tools/video", label: { zh: "视频脚本", en: "Video" } },
  { href: "/tools/article", label: { zh: "文章", en: "Article" } },
  { href: "/tools/app", label: { zh: "APP", en: "App" } },
  { href: "/tools/ppt", label: { zh: "PPT 大纲", en: "PPT" } },
  { href: "/tools/ui", label: { zh: "UI 设计", en: "UI" } },
  { href: "/tools/web", label: { zh: "网页", en: "Web" } },
  { href: "/tools/prd", label: { zh: "PRD", en: "PRD" } },
  { href: "/tools/resume", label: { zh: "简历", en: "Resume" } },
  { href: "/tools/skill", label: { zh: "AI 角色", en: "Skill" } },
  ...
  { href: "/privacy", label: { zh: "隐私", en: "Privacy" } },
] as const;
